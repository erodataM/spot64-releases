...
APP_TAG="${SPOT64_APP_TAG:-v0.1.0-beta.11}"
CORPUS_TAG="${SPOT64_CORPUS_TAG:-v0.1.0-beta.7}"
APP_ASSET="Spot64_0.1.0-beta.11_aarch64.dmg"
APP_SHA256="b9b8923880a7b5261c32119c5f126cc624b96c40b2594b4f4e2dae2b0f49fe57"
