...
APP_TAG="${SPOT64_APP_TAG:-v0.1.0-beta.12}"
CORPUS_TAG="${SPOT64_CORPUS_TAG:-v0.1.0-beta.7}"
APP_ASSET="Spot64_0.1.0-beta.12_aarch64.dmg"
APP_SHA256="41604ba7fa9047153a5488f23c8f5509f4e14da11ab2f42ff5e02607866b05a7"
