...
APP_TAG="${SPOT64_APP_TAG:-v0.1.0-beta.13}"
CORPUS_TAG="${SPOT64_CORPUS_TAG:-v0.1.0-beta.7}"
APP_ASSET="Spot64_0.1.0-beta.13_aarch64.dmg"
APP_SHA256="501a76dc52690b13db4dba9d346a6aeb7e6f158cb45954201a5f1fa81e4cb7c7"
